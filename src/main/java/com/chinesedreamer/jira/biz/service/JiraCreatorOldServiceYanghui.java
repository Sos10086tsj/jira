 ...
 * @version beta
 */
public class JiraCreatorOldServiceYanghui extends JiraCreatorOldService{
	...
	static{
		...
		devMap.put("yangzl", "【ios】");
		devMap.put("heyb", "【ios】");
	}

	public JiraCreatorOldServiceYanghui(JiraClient jiraClient) {
		super(jiraClient);
	}

	@Override
	public List<Issue> createIssues(String project, String issueType,
			String version, List<CrudOldVo> vos)
